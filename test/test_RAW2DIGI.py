...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring( ( 'drop *', 'keep *_castorDigis_*_*') ),
...
process.castorDigis.InputLabel = cms.InputTag("source")
...
process.TFileService = cms.Service("TFileService",
		fileName = cms.string("ZDCDigi_284671.root")
		)


# Path and EndPath definitions
#process.raw2digi_step = cms.Path(process.RawToDigi)
process.raw2digi_step = cms.Path(process.castorDigis * process.analyzer)
